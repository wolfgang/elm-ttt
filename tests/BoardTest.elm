...
modelWithBoard c00 c10 c20 c01 c11 c21 c02 c12 c22 =
    let
        ( model, _ ) =
            Init.init
    in
        { model | board = board c00 c10 c20 c01 c11 c21 c02 c12 c22 }
...
board c00 c10 c20 c01 c11 c21 c02 c12 c22 =
    [ { coords = ( 0, 0 ), state = c00 }
    , { coords = ( 1, 0 ), state = c10 }
    , { coords = ( 2, 0 ), state = c20 }
    , { coords = ( 0, 1 ), state = c01 }
    , { coords = ( 1, 1 ), state = c11 }
    , { coords = ( 2, 1 ), state = c21 }
    , { coords = ( 0, 2 ), state = c02 }
    , { coords = ( 1, 2 ), state = c12 }
    , { coords = ( 2, 2 ), state = c22 }
    ]
